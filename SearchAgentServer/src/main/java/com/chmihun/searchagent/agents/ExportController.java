...
public class ExportController {
     ...
     **/
    public static boolean generateStatisticsForPeriod(DBType dbType, String query, String startDate, String endDate, String webappPath) {
        if (dbType != null) {
            ArrayList<String> stat = DBFactory.getDatabaseInstance(dbType).getStatisticsForPeriod(query, startDate, endDate);
            ...
            logger.error("Agent type (database name) that is specified by the client side isn't correct.");
            return false;
        }
    }
}
